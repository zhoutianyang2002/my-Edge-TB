...
if __name__ == '__main__':
	testbed = default_testbed (ip='106.53.110.245', dir_name=dirName, manager_class=ElManager)#ct
	...
	emu1 = testbed.add_emulator (name='emulator-1', ip='111.230.154.108', cpu=16, ram=64, unit='G')#zty
	...
	en.mount_local_path (local_path='./dml_file',node_path='/home/worker/dml_file')
	...
	emu2 = testbed.add_emulator ('emulator-2', '114.132.177.213', cpu=128, ram=256, unit='G')#whl
	for i in range (2, 5):
	...
	p1 = testbed.add_physical_node (name='p1', nic='eth0', ip='81.71.23.105')
	...
	links_json = read_json (os.path.join (dirName, 'el_links.json'))
