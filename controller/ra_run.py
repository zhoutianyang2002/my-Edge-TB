...
if __name__ == '__main__':
	testbed = default_testbed (ip='106.53.110.245', dir_name=dirName, manager_class=RaManager)
	...
	# emu1 = testbed.add_emulator (name='emulator-1', ip='159.75.112.104', cpu=8, ram=16, unit='G')
	...
	# 	cmd=['python3', 'ra_peer.py'], image='dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu1)
	...
	# # ！！！注意下面这句话，如果想用本地数据集，对于后面每个模拟节点都要记得加上（而且注意路径是包含数据集信息的硬编码）
	...
	# emu1 = testbed.add_emulator ('emulator-1', '159.75.112.104', cpu=8, ram=32, unit='G')
	# for i in range (1, 6):
	# 	en = testbed.add_emulated_node ('n' + str (i), '/home/worker/dml_app',
	# 		['python3', 'ra_peer.py'], 'dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu1)
	# 	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	...
	emu2 = testbed.add_emulator (name='emulator-2', ip='81.71.23.105', cpu=8, ram=16, unit='G')
	en = testbed.add_emulated_node (name='n2', working_dir='/home/worker/dml_app',
		cmd=['python3', 'ra_peer.py'], image='dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu2)
	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	en.mount_nfs (nfs=nfsApp, node_path='/home/worker/dml_app')
	en.mount_nfs (nfsDataset, '/home/worker/dataset')

	emu3 = testbed.add_emulator (name='emulator-3', ip='111.230.154.108', cpu=8, ram=16, unit='G')
	en = testbed.add_emulated_node (name='n3', working_dir='/home/worker/dml_app',
		cmd=['python3', 'ra_peer.py'], image='dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu3)
	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	en.mount_nfs (nfs=nfsApp, node_path='/home/worker/dml_app')
	en.mount_nfs (nfsDataset, '/home/worker/dataset')

	emu4 = testbed.add_emulator (name='emulator-4', ip='114.132.177.213', cpu=8, ram=16, unit='G')
	en = testbed.add_emulated_node (name='n4', working_dir='/home/worker/dml_app',
		cmd=['python3', 'ra_peer.py'], image='dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu4)
	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	en.mount_nfs (nfs=nfsApp, node_path='/home/worker/dml_app')
	en.mount_nfs (nfsDataset, '/home/worker/dataset')

	# # add many emulated nodes.
	# emu2 = testbed.add_emulator ('emulator-2', '111.230.154.108', cpu=8, ram=16, unit='G')
	# for i in range (2, 4):
	# 	en = testbed.add_emulated_node ('n' + str (i), '/home/worker/dml_app',
	# 		['python3', 'ra_peer.py'], 'dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu2)
	# 	# ${host_path} means /path/in/emulator-2/to/worker/dml_file in this example.
	# 	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	# 	en.mount_nfs (nfsApp, '/home/worker/dml_app')
	# 	en.mount_nfs (nfsDataset, '/home/worker/dataset')

	# emu3 = testbed.add_emulator ('emulator-3', '114.132.177.213', cpu=8, ram=16, unit='G')
	# for i in range (4, 6):
	# 	en = testbed.add_emulated_node ('n' + str (i), '/home/worker/dml_app',
	# 		['python3', 'ra_peer.py'], 'dml:v1.0', cpu=1, ram=1, unit='G', emulator=emu3)
	# 	en.mount_local_path ('./dml_file', '/home/worker/dml_file')
	# 	en.mount_nfs (nfsApp, '/home/worker/dml_app')
	# 	en.mount_nfs (nfsDataset, '/home/worker/dataset')
	...
	# p1 = testbed.add_physical_node (name='p1', nic='eth0', ip='114.132.177.213')
